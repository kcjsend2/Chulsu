...
public:
	...
	~ResourceStateTracker();
	void TransitionBarrier(Microsoft::WRL::ComPtr<ID3D12GraphicsCommandList4> CmdList, ID3D12Resource* resource, D3D12_RESOURCE_STATES state);
...
private:
	std::unordered_map<ID3D12Resource*, D3D12_RESOURCE_STATES> mResourceStateMap;
};